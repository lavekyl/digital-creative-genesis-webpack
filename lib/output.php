...
add_action( 'wp_enqueue_scripts', 'dcg_css' );
/**
...
function dcg_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'dcg_logo_width', 350 );
	...
	$css .= ( dcg_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( dcg_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
