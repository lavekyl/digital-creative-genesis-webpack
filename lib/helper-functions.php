 ...
 */
function dcg_customizer_get_default_link_color() {
 ...
 */
function dcg_customizer_get_default_accent_color() {
 ...
 */
function dcg_color_contrast( $color ) {
 ...
 */
function dcg_color_brightness( $color, $change ) {
