...
add_action( 'wp_enqueue_scripts', 'dcg_products_match_height', 99 );
/**
 * Print an inline script to the footer to keep products the same height.
 *
 * @since 2.3.0
 */
function dcg_products_match_height() {
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'dcg_woocommerce_breakpoint' );
/**
 ...
 */
function dcg_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'dcg_default_products_per_page' );
/**
 ...
 */
function dcg_default_products_per_page() {
	return 8;
}

add_filter( 'woocommerce_pagination_args', 'dcg_woocommerce_pagination' );
/**
 ...
 */
function dcg_woocommerce_pagination( $args ) {
...
add_action( 'after_switch_theme', 'dcg_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Define WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function dcg_woocommerce_image_dimensions_after_theme_setup() {
	...
	dcg_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'dcg_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 * @since 2.3.0
 */
function dcg_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function dcg_update_woocommerce_image_dimensions() {
